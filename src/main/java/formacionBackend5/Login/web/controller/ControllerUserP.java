...
public class ControllerUserP {
    ...
    /*Se añadirá a la tabla personas el campo
       ...
       Después se creará el endpoint /login que pedirá usuario y password  devolviendo un token JWT firmado si los datos
        son válidos comprobando contra la tabla ‘personas’.
